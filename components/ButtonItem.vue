    ...
    <div v-if="item.unlocked == true" class="col-12 col-lg-4 col-xl-3 col-xxl-2">
        <div class="list-group-item list-group-item-action py-0 px-1" :class="{ 'active':active }">
            <div class="row gx-2 align-items-center">
                <div class="col pe-0">
                    <button type="button" class="w-100 position-relative btn py-0 px-0 align-items-center justify-content-center" @click="$emit('click')">
                ...
                <div class="col-auto py-1">
                    <button v-if="item.state == 'paused'" type="button" class="btn btn-sm p-1 btn-primary mb-1" :class="{ 'disabled':item.productionLevel < 1 }" @click="run()">
                        <span><i class="fas fa-fw fa-play"></i></span>
                    </button>
                    <button v-if="item.state != 'paused'" type="button" class="position-relative btn btn-sm p-1 btn-primary mb-1" @click="pause()">
