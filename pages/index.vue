...
var storageData = [
    ...
    {	id:'stoneS1',               icon:'ironChest',               name:'ironChest',       itemId:'stone',             storage:50,    costs:{ stone:50 }, },
    {	id:'stoneBrickS1',          icon:'ironChest',               name:'ironChest',       itemId:'stoneBrick',        storage:50,    costs:{ stoneBrick:50 }, },
    {	id:'concreteS1',            icon:'ironChest',               name:'ironChest',       itemId:'concrete',          storage:50,    costs:{ concrete:50 }, },
    {	id:'ironS1',                icon:'ironChest',               name:'ironChest',       itemId:'iron',              storage:50,    costs:{ iron:50 }, },
    {	id:'ironPlateS1',           icon:'ironChest',               name:'ironChest',       itemId:'ironPlate',         storage:50,    costs:{ ironPlate:50 }, },
    {	id:'steelPlateS1',          icon:'ironChest',               name:'ironChest',       itemId:'steelPlate',        storage:50,    costs:{ steelPlate:50 }, },
    {	id:'engineS1',              icon:'ironChest',               name:'ironChest',       itemId:'engine',            storage:50,    costs:{ engine:50 }, },
    {	id:'electricEngineS1',      icon:'ironChest',               name:'ironChest',       itemId:'electricEngine',    storage:50,    costs:{ electricEngine:50 }, },
    {	id:'copperS1',              icon:'ironChest',               name:'ironChest',       itemId:'copper',            storage:50,    costs:{ copper:50 }, },
    {	id:'copperPlateS1',         icon:'ironChest',               name:'ironChest',       itemId:'copperPlate',       storage:50,    costs:{ copperPlate:50 }, },
    {	id:'processingUnitS1',      icon:'ironChest',               name:'ironChest',       itemId:'processingUnit',    storage:50,    costs:{ processingUnit:50 }, },
    {	id:'waterS1',               icon:'waterBarrel',             name:'barrel',          itemId:'water',             storage:50,    costs:{ water:50 }, },
    {	id:'oilS1',                 icon:'oilBarrel',               name:'barrel',          itemId:'oil',               storage:50,    costs:{ oil:50 }, },
    {	id:'heavyOilS1',            icon:'heavyOilBarrel',          name:'barrel',          itemId:'heavyOil',          storage:50,    costs:{ heavyOil:50 }, },
    {	id:'lubricantS1',           icon:'lubricantBarrel',         name:'barrel',          itemId:'lubricant',         storage:50,    costs:{ lubricant:50 }, },
    {	id:'lightOilS1',            icon:'lightOilBarrel',          name:'barrel',          itemId:'lightOil',          storage:50,    costs:{ lightOil:50 }, },
    {	id:'petroleumGasS1',        icon:'petroleumGasBarrel',      name:'barrel',          itemId:'petroleumGas',      storage:50,    costs:{ petroleumGas:50 }, },
    {	id:'plasticBarS1',          icon:'ironChest',               name:'ironChest',       itemId:'plasticBar',        storage:50,    costs:{ plasticBar:50 }, },
    {	id:'solidFuelS1',           icon:'ironChest',               name:'ironChest',       itemId:'solidFuel',         storage:50,    costs:{ solidFuel:50 }, },
    {	id:'sulfurS1',              icon:'ironChest',               name:'ironChest',       itemId:'sulfur',            storage:50,    costs:{ sulfur:50 }, },
    {	id:'sulfuricAcidS1',        icon:'sulfuricAcidBarrel',      name:'barrel',          itemId:'sulfuricAcid',      storage:50,    costs:{ sulfuricAcid:50 }, },
    {	id:'batteryS1',             icon:'ironChest',               name:'ironChest',       itemId:'battery',           storage:50,    costs:{ battery:50 }, },
    {	id:'rocketFuelS1',          icon:'ironChest',               name:'ironChest',       itemId:'rocketFuel',        storage:50,    costs:{ rocketFuel:50 }, },
    {	id:'rocketPartS1',          icon:'ironChest',               name:'ironChest',       itemId:'rocketPart',        storage:50,    costs:{ rocketPart:50 }, },
    {	id:'redPackS1',             icon:'ironChest',               name:'ironChest',       itemId:'redPack',           storage:50,    costs:{ redPack:50 }, },
    {	id:'greenPackS1',           icon:'ironChest',               name:'ironChest',       itemId:'greenPack',         storage:50,    costs:{ greenPack:50 }, },
    {	id:'bluePackS1',            icon:'ironChest',               name:'ironChest',       itemId:'bluePack',          storage:50,    costs:{ bluePack:50 }, },
    {	id:'purplePackS1',          icon:'ironChest',               name:'ironChest',       itemId:'purplePack',        storage:50,    costs:{ purplePack:50 }, },
    {	id:'yellowPackS1',          icon:'ironChest',               name:'ironChest',       itemId:'yellowPack',        storage:50,    costs:{ yellowPack:50 }, },
]
