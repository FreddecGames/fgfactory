...
var easyItemData = [
    ...
    {	id:'alienEgg',              type:'item', reqs:[ 'military1' ],                  productionLevel:0,    },
]
...
var easyWeaponData = [
    ...
    {	id:'pistol',                type:'weapon', reqs:[ 'military1' ],    auto:false,     max:1,    time:5,	    costs:{ ironPlate:5, copperPlate:5 },                                                   fireTime:.25,   },
